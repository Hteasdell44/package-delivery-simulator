...
class Package:
    ...
    def update_status(self, convert_timedelta):
        ...
        # Prevents any truck/package from leaving the station before 8am.
        ...
        if self.ID in [2, 4, 5, 7, 8, 9, 10, 11, 12, 25, 28, 32, 33] and convert_timedelta < datetime.timedelta(hours=10, minutes=20) or self.ID in [3, 6, 17, 18, 21, 22, 23, 24, 26, 27, 35, 36, 38, 39] and convert_timedelta < datetime.timedelta(hours=9, minutes=5):
            self.status = "At The Hub!"
